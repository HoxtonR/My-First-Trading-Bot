...
public interface BinanceApiService {
    ...
    Call<FutureTransaction> transferFuture(@Query("asset") String asset, @Query("amount") String amount, @Query("type") String type, @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
}
