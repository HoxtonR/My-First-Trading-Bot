...
public class HuobiSpotTradeXMarket {
    ...
    public HuobiSpotTradeXMarket(String apikey, String secretkey, Long accountId) {
        this.apikey = apikey;
    ...
    public String[] RequestBuilder(String cointype, String type, String quantity) throws Exception {
        String head = "POST\n";
    ...
    public void HuobiSpotLimitBuyX(String cointype, String quantity) throws Exception {
        String[] a = RequestBuilder(cointype, "buy-market", quantity);
        sendRequest(a[0], a[1]);
    }

    public static void main(String[] args) throws Exception {
        System.out.println(LocalDateTime.now());
        HuobiSpotTradeXMarket tradex = new HuobiSpotTradeXMarket("8494ebce-dbuqg6hkte-10e89102-6ce6e", "b0413b52-b7e6304b-a3b593b6-c0641", 16810182L);
        String[] a = tradex.RequestBuilder("btcusdt", "buy-limit", "0.001");
