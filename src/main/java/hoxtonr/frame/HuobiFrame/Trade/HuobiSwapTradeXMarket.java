...
public class HuobiSwapTradeXMarket {
    ...
    public HuobiSwapTradeXMarket(String apikey, String secretkey, Long accountId) {
        this.apikey = apikey;
    ...
    public String[] RequestBuilder(String cointype, String volume, String direction, String offset, int leverage) throws Exception {
        String head = "POST\n";
        ...
        request.append("{").append("\"contract_code\":").append("\"").append(cointype).append("\"").append(",")
                ...
                .append("\"order_price_type\":").append("\"").append("optimal_20").append("\"").append(",")
    ...
    public void HuobiSwapMarketBuyX(String cointype, String volume, String direction, String offset, int leverage) throws Exception {
        String[] a = RequestBuilder(cointype,volume,direction,offset,leverage);
        sendRequest(a[0],a[1]);
    }
}
