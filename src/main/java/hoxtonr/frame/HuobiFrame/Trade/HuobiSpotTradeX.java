...
public class HuobiSpotTradeX {
    ...
    public HuobiSpotTradeX(String apikey, String secretkey, Long accountId) {
        this.apikey = apikey;
    ...
    public String[] RequestBuilder(String cointype, String type, String quantity, String price) throws Exception {
        String head = "POST\n";
        String url = "api.huobi.pro\n";
        String url2 = "/v1/order/orders/place\n";
        String time = gmtNow();
        ...
        String temp2 = "https://api.huobi.pro/v1/order/orders/place?" + build.toString();
        StringBuilder request  = new StringBuilder();
        request.append("{").append("\"account-id\":").append("\"").append(accountId).append("\"").append(",")
                .append("\"symbol\":").append("\"").append(cointype).append("\"").append(",")
                .append("\"type\":").append("\"").append(type).append("\"").append(",")
                .append("\"amount\":").append("\"").append(quantity).append("\"").append(",")
    ...
    public void HuobiSpotLimitBuyX(String cointype, String quantity, String price) throws Exception {
        String[] a = RequestBuilder(cointype,"buy-limit",quantity,price);
        sendRequest(a[0],a[1]);
    }
    public static void main(String[] args) throws Exception {
        System.out.println(LocalDateTime.now());
        HuobiSpotTradeX tradex = new HuobiSpotTradeX("8494ebce-dbuqg6hkte-10e89102-6ce6e", "b0413b52-b7e6304b-a3b593b6-c0641", 16810182L);
        String[] a = tradex.RequestBuilder("btcusdt", "buy-limit", "0.001", "40000.00");
        System.out.println(a[0]);
        System.out.println(a[1]);
        tradex.sendRequest(a[0],a[1]);
        System.out.println(LocalDateTime.now());
    }
}
