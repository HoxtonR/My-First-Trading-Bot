...
public class HuobiSwapPriceListener {
    public String HuobiSwapPrice() throws InterruptedException, IOException {
        ...
        String url = "https://api.hbdm.com/linear-swap-ex/market/detail/batch_merged";
